...
public class PurchaseService {
    ...
    public void process() {
//        List<PurchaseFinished> purchaseFinishedList = purchaseFinishedRepository.findAll();
        List<String> orderNoList = new ArrayList<>();

//        for (PurchaseFinished purchaseFinished : purchaseFinishedList) {
//            orderNoList.add(purchaseFinished.getOrderNo().trim());
//        }
//        List<Order> orderList = orderRepository.findByOrderNoNotIn(orderNoList);
        ...
        for (Order order : orderList) {
            ...
            if (!StringUtils.isEmpty(skuName) && !StringUtils.isEmpty(skuDetail)
